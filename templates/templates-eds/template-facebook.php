...
.art_block strong, .art_content h1, .art_content h2, .art_content h3, .art_content h4, .art_content h5, .art_content h6 {color: #753200; font-size: 16px; margin-bottom: 5px;font-weight:700;}

.later-content{display:none;}
.article__image{display:none;}
.serp{padding:20px 0 20px;}
...
.readMoreBtn:hover{color:#753200;}
...
<section class="serp">
    <div class="wrapper container">
        ...
        <div class="top-ed-wrapp"><?php include(locate_template('templates/top-eds-fb-2.php')); ?></div>
        ...
        <?php endif;  ?>
        <div class="bottom-ed-wrapp"><?php include(locate_template('templates/bottom-eds-fb-2.php')); ?></div>
    </div>
</section>
<?php get_footer(); ?>
